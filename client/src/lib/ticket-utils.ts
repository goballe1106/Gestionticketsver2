...
// Obtener la categoría de prioridad
export function getTicketPriorityCategory(ticketType: string | undefined): string {
  if (!ticketType) return 'Media Prioridad';
